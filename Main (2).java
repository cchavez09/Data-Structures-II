...
class BloomFilter {
    ...
    public boolean contains(String s) {
      ...
      for (int i = 0; i < noHashes; i++) {
        // get the hash code for the current string for the current
        // hash function, and this.hashMask to get the bit index
        int index = (int) (hashCode(s, i)) & this.hashMask;
        // if the bit at the index isn't set
